...
namespace TheBugTracker.Services
{
    public class BTRolesService : IBTRolesService
    {
        ...
        {
            List<string> userId = (await _userManager.GetUsersInRoleAsync(roleName)).Select(u => u.Id).ToList();
            List<BTUser> roleUsers = _context.Users.Where(u => !userId.Contains(u.Id)).ToList();
