...
namespace TheBugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Title,Message,Createrd,RecipientId,SenderId,Viewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Title,Message,Createrd,RecipientId,SenderId,Viewed")] Notification notification)
        {
